...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    title: 'Unlock PDF',
    description: 'Remove a password from a PDF — the unlock happens entirely in your browser.',
    category: 'PDF',
    icon: Shield01Icon,
  },
  {
    ...
    title: 'Protect PDF',
    description: 'Add a password and encryption to a PDF without uploading it.',
    category: 'PDF',
    icon: Shield01Icon,
  },
  {
    ...
    description: 'Extract a PDF as Markdown text locally — nothing is uploaded.',
    category: 'PDF',
    icon: File01Icon,
  },
  {
    ...
    title: 'PDF to Word',
    description: 'Extract a PDF as an editable .docx locally — text only, no upload.',
    category: 'PDF',
    icon: File01Icon,
  },
  {
    ...
    href: '/tools/pdf-crop',
    title: 'Crop PDF',
    description: 'Trim margins from every page of a PDF locally.',
    category: 'PDF',
    icon: ImageCropIcon,
  },
  {
    ...
    description: 'Stamp "Page N of M" onto every page of a PDF locally.',
    category: 'PDF',
    icon: Stamp01Icon,
  },
];
